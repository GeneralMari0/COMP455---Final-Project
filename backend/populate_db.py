            ...
            for row in reader:
                try:
                    ...
                    action = {
                        '_op_type': 'index',
                        '_index': 'books',
                        # Using isbn13 as the document ID since all books in our dataset have unique isbn13 values
                        # Might switch back to meta={'id': 1} like we did before? idk
                        # If None, then id is auto generated by Elasticsearch
                        '_id': isbn13 or None,
                        '_source': {
                            'title': title,
                            'author': author,
